                                                                  ...
                                                                  <span style="font-size: 16px; line-height: 22.4px;">
                                                                    <strong>
                                                                      <span style="color: #595959; line-height: 22.4px; font-size: 16px;">
                                                                        {{session('first_name').' '.session('last_name').' '.session('ext_name')}}
                                                                      </span>
                                                                    </strong>
                                                                  </span>
                                                                </p>
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                          ...
                                                          <div style="line-height: 140%; text-align: center; word-wrap: break-word;">
                                                              ...
                                                              <p style="font-size: 14px; line-height: 140%;">
                                                                <strong>
                                                                  <span style="font-size: 16px; line-height: 22.4px;">
                                                                    {{\Carbon\Carbon::now()->format('Y-m-d, h:i A')}}
                                                                  </span>
                                                                </strong>
                                                              </p>
                                                          </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <a style="text-decoration: none" href="{{url('/login')}}"
                                                                    style="font-size: 14px; line-height: 140%;"><span
                                                                        style="background-color: #2dc26b; font-size: 14px; line-height: 19.6px; color: #000000;">
