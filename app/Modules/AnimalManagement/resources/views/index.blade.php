...
@section('page-js')
    ...
    @include('AnimalManagement::js.js')
...
<!-- begin page-header -->
<h1 class="page-header">Animal Management</h1>
<!-- end page-header -->
...
<div class="panel  ">
    <div class="panel-heading">        
        ...
        <button type='button' class='btn btn-primary'data-toggle='modal' data-target='#AddModal' >
            <i class='fa fa-plus'></i> Add New Animal
        </button>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input style="text-transform: capitalize;"  name="animal_name" class="form-control"  placeholder="Please enter animal name here..."  >                                    
                                </div>&nbsp;                            
                            </div>                  
