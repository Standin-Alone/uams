                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="{{$message->embed(public_path('/edcel_images/DA-Logo.png'))}}" alt="Role"
                                      title="Role"
                            ...
                            <tbody>
                                <tr>
                                    <td class="v-container-padding-padding"
                                        style="overflow-wrap:break-word;word-break:break-word;padding:15px;font-family:arial,helvetica,sans-serif; background-color:#90EE90"
                                        align="left">
                                        ...
                                        <h4
                                            style="margin: 0px line-height: 140%; text-align: left; word-wrap: break-word; font-weight: normal; font-family: arial,helvetica,sans-serif; font-size: 14px;">
                                               Please proceed to this link to create your user account. <br>
                                               {{$link}}
                                            <br>
