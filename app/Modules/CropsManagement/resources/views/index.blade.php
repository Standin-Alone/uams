...
<!-- begin page-header -->
<h1 class="page-header">Crops Management</h1>
<!-- end page-header -->
...
<div class="panel  ">
    <div class="panel-heading">        
        ...
        <button type='button' class='btn btn-primary'data-toggle='modal' data-target='#AddModal' >
            <i class='fa fa-plus'></i> Add New Crop
        </button>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Crop Name (English)</label> <span style="color:red">*</span>
                                    <input style="text-transform: capitalize;"  name="crop_english" class="form-control"  placeholder="Please enter crop name here..."  >                                    
                                </div>&nbsp;                            
                            </div>                  
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Crop Name (Tagalog)</label> <span style="color:red">*</span>
                                    <input style="text-transform: capitalize;"  name="crop_tagalog" class="form-control"  placeholder="Please enter crop name here..."  >                                    
                                </div>&nbsp;                            
                            </div>                                               
                            {{--modal body end--}}
                        </div>
                ...
                <form id="UpdateForm" method="POST" >
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="text" name="crop_id" class="hide"/>

                            {{--modal body start--}}
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Crop Name (English)</label> <span style="color:red">*</span>
                                    <input style="text-transform: capitalize;"  name="crop_english" id="crop_english"  class="form-control"  placeholder="Please enter crop name here..."  >                                    
                                </div>&nbsp;                            
                            </div>                  
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Crop Name (Tagalog)</label> <span style="color:red">*</span>
                                    <input style="text-transform: capitalize;"  name="crop_tagalog" id="crop_tagalog" class="form-control"  placeholder="Please enter crop name here..."  >                                    
                                </div>&nbsp;                            
                            </div>                                               
                            {{--modal body end--}}
                        </div>
