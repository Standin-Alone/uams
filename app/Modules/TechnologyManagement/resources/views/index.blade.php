@extends('global.base')
@section('title', "Technology Management")
...
@section('page-js')
    ...
    @include('TechnologyManagement::js.js')
...
<!-- begin page-header -->
<h1 class="page-header">Technology Management</h1>
<!-- end page-header -->
...
<div class="panel  ">
    <div class="panel-heading">        
        ...
        <button type='button' class='btn btn-primary'data-toggle='modal' data-target='#AddModal' >
            <i class='fa fa-plus'></i> Add New Technology
        </button>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Technology Description </label> <span style="color:red">*</span>
                                    <input style="text-transform: capitalize;"  name="tech_desc" class="form-control"  placeholder="Please enter description here..."  >                                    
                                </div>&nbsp;                            
                            </div>                  
                ...
                <form id="UpdateForm" method="POST" >
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="text" name="tech_id" class="hide"/>

                            {{--modal body start--}}
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Animal Name </label> <span style="color:red">*</span>
                                    <input style="text-transform: capitalize;"  name="tech_desc" id="tech_desc" class="form-control"  placeholder="Please enter animal name here..."  >                                    
                                </div>&nbsp;                            
                            </div>                                    
                            {{--modal body end--}}
                        </div>
